...
export const CSP_POLICY = [
  ...
  "img-src 'self' data: blob: https://*.supabase.co https://storage.googleapis.com https://*.lovableproject.com https://*.lovable.app https://maps.googleapis.com https://maps.gstatic.com https://*.googleapis.com https://*.ggpht.com https://*.tile.openstreetmap.org https://tile.openstreetmap.org",
  "font-src 'self' data: https://fonts.gstatic.com https://cdn.jsdelivr.net",
  "connect-src 'self' https://maps.googleapis.com https://*.googleapis.com https://*.supabase.co wss://*.supabase.co https://cdn.gpteng.co https://raw.githack.com https://raw.githubusercontent.com https://*.lovableproject.com wss://*.lovableproject.com https://*.lovable.app wss://*.lovable.app ws://localhost:* wss://localhost:*",
